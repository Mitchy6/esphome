...
class EPD6 : public PollingComponent, public display::DisplayBuffer, public i2c::I2CDevice {
 public:
  ...
  void set_extdata_pin(GPIOPin *extdata) { this->extdata_pin_ = extdata; }
  void set_clk_pin(GPIOPin *clk) { this->clk_pin_ = clk; }
  void set_stb_pin(GPIOPin *stb) { this->stb_pin_ = stb; }
